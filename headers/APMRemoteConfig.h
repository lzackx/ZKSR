...
@class APMDatabase, APMEClient, APMEManager, APMPBMeasurementConfig, APMPEventEditing, GULMutableDictionary, NSArray, NSNumberFormatter, NSString;
...
@property(readonly, nonatomic) _Bool nonBlockingAppInstanceIDEnabled;
