...
- (int)appendAudioData:(id)arg1 audioFormat:(int)arg2 withDelegate:(id)arg3 audioOffset:(double)arg4 audioSampleRate:(int)arg5;
...
- (void)pause;
- (void)pauseIfNeeded;
- (int)playData:(id)arg1 audioFormat:(int)arg2 withDelegate:(id)arg3 audioOffset:(double)arg4 audioSampleRate:(int)arg5;
- (int)receiveMP3Stream:(id)arg1;
- (int)receivePCM8KStream:(id)arg1;
- (int)receivePCMStream:(id)arg1;
