...
@protocol BU_SDAnimatedImage, OS_dispatch_semaphore;
...
@interface BU_SDAnimatedImageView : UIImageView <CALayerDelegate>
{
    ...
    UIImage<BU_SDAnimatedImage> *_animatedImage;
...
- (void).cxx_destruct;
@property(retain, nonatomic) UIImage<BU_SDAnimatedImage> *animatedImage; // @synthesize animatedImage=_animatedImage;
