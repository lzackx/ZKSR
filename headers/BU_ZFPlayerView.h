...
@class AVAssetImageGenerator, AVPlayer, AVPlayerItem, AVPlayerLayer, BUResourceLoaderManager, BU_ZFPlayerModel, CALayer, NSArray, NSDictionary, NSIndexPath, NSString, NSURL, UIImage, UIPanGestureRecognizer, UIScrollView, UISlider, UITapGestureRecognizer;
