...
- (void)gdt_seekToTime:(double)arg1 tolerance:(CDStruct_198678f7)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)gdt_seekToTimeWithPositiveInfinity:(double)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)gdt_stop;
