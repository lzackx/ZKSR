...
@class KSYD_OtherRewardVideoAdManager, NSString, UIButton, UITextField;

@interface KSYD_AskBookController : KSYD_BaseViewController <UITextFieldDelegate>
{
...
@property(nonatomic) __weak UIButton *seleBtn; // @synthesize seleBtn=_seleBtn;
