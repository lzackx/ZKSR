...
@class KSYD_AskBookModel, UILabel, UIView;

@interface KSYD_AskBookViewCell : UITableViewCell
{
    KSYD_AskBookModel *_model;
    UILabel *_bookName;
...
@property(retain, nonatomic) KSYD_AskBookModel *model; // @synthesize model=_model;
