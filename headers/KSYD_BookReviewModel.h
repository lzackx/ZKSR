...
@class KSYD_BookHelpfulModel, NSDate, NSString;

@interface KSYD_BookReviewModel : YBaseModel
{
    long long _commentCount;
    NSString *_content;
    NSDate *_created;
    KSYD_BookHelpfulModel *_helpful;
...
@property(retain, nonatomic) KSYD_BookHelpfulModel *helpful; // @synthesize helpful=_helpful;
