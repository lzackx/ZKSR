...
@class KSYD_AdvertConfigModel, KSYD_ErrorStatusView, KSYD_NetworkManager, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView, UIScrollView, UIView;
@protocol BookStoreEndViewControllerDelegate;

@interface KSYD_BookStoreEndViewController : KSYD_BaseViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, KSYD_AdvertContentViewDelegate, KSYD_ErrorStatusViewDelegate>
{
    _Bool _isInTab;
    _Bool _isLoading;
    _Bool _TopADLoad;
