...
@class GADBannerView, GDTNativeExpressAd, GDTNativeExpressAdView, KSYD_AdvertModel, KSYD_NetworkManager, NSArray, NSMutableArray, NSString, UIScrollView, YBookDetailModel, YYLabel;

@interface KSYD_CatalogDetailController : KSYD_BaseViewController <UIScrollViewDelegate, GADBannerViewDelegate, GDTNativeExpressAdDelegete>
{
