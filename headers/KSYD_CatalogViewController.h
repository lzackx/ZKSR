...
@class KSYD_AdvertContentView, KSYD_ReaderManager, KSYD_ScrollBar, NSArray, NSString, UILabel, UITableView, UIView, UIViewController, YBookDetailModel;

@interface KSYD_CatalogViewController : KSYD_BaseViewController <UITableViewDelegate, UITableViewDataSource, KSYD_ScrollBarDelegate, KSYD_AdvertContentViewDelegate>
{
    _Bool _isCatalog;
    _Bool _isDescending;
