...
@class KSYD_AdvertContentView, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout;

@interface KSYD_ClassifyViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate, KSYD_AdvertContentViewDelegate>
{
    _Bool _isInTab;
    _Bool _canScroll;
