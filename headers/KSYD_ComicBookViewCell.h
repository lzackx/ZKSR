...
@class KSYD_ComicBookModel, KSYD_ProgressView, NSIndexPath, NSLayoutConstraint, NSString, UIButton, UIImageView, UILabel, UIView;
@protocol KSYD_ComicBookViewCellDelegate;

@interface KSYD_ComicBookViewCell : UITableViewCell
{
    _Bool _isLastRead;
    NSIndexPath *_indexPath;
    KSYD_ComicBookModel *_bookM;
    NSString *_recordPercent;
    UIButton *_detailBtn;
    id <KSYD_ComicBookViewCellDelegate> _delegate;
    UIView *_pointView;
...
@property(retain, nonatomic) KSYD_ComicBookModel *bookM; // @synthesize bookM=_bookM;
- (void)clickDetail:(id)arg1;
@property(nonatomic) __weak id <KSYD_ComicBookViewCellDelegate> delegate; // @synthesize delegate=_delegate;
