...
#import "KSYD_ComicBookSelfAlertViewDelegate-Protocol.h"
#import "KSYD_ComicBookViewCellDelegate-Protocol.h"
#import "KSYD_ComicCollectionViewCellDelegate-Protocol.h"
...
@class AFHTTPSessionManager, KSYD_AdvertContentView, KSYD_ComicBookManager, KSYD_ComicBookSelfAlertView, KSYD_NetworkManager, NSArray, NSMutableArray, NSString, NSURLSessionTask, SGHorseRaceLampView, SPAlertController, UIBarButtonItem, UIButton, UICollectionView, UITableView, UIView, YYCache;

@interface KSYD_ComicBookselfViewController : KSYD_BaseViewController <UITableViewDelegate, UITableViewDataSource, SKStoreProductViewControllerDelegate, SDCycleScrollViewDelegate, UIGestureRecognizerDelegate, KSYD_ComicBookViewCellDelegate, KSYD_ComicBookSelfAlertViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, KSYD_ComicCollectionViewCellDelegate, KSYD_AdvertContentViewDelegate, UIViewControllerTransitioningDelegate>
{
    _Bool _isOneTime;
    _Bool _isLoading;
    ...
    YYCache *_cache;
    KSYD_ComicBookSelfAlertView *_alerView;
...
@property(retain, nonatomic) KSYD_ComicBookSelfAlertView *alerView; // @synthesize alerView=_alerView;
...
- (void)netWorkSolve;
@property(retain, nonatomic) UIView *nilBookView; // @synthesize nilBookView=_nilBookView;
