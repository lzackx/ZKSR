...
#import "KSYD_ScrollBarDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class KSYD_AdvertContentView, KSYD_ComicBookModel, KSYD_ErrorStatusView, KSYD_ReaderManager, KSYD_ScrollBar, NSArray, NSString, UILabel, UITableView, UIView, UIViewController;

@interface KSYD_ComicCatalogViewController : KSYD_BaseViewController <UITableViewDelegate, UITableViewDataSource, KSYD_ScrollBarDelegate, KSYD_AdvertContentViewDelegate, KSYD_ErrorStatusViewDelegate>
{
    _Bool _isCatalog;
    _Bool _isDescending;
    ...
    KSYD_ComicBookModel *_readingBook;
    UIViewController *_vc;
    UITableView *_tableView;
    KSYD_ScrollBar *_scrollBar;
...
- (void).cxx_destruct;
- (void)KSYD_buildUI;
- (void)KSYD_clickRankBtn:(id)arg1;
- (void)KSYD_getData;
...
@property(retain, nonatomic) KSYD_ComicBookModel *readingBook; // @synthesize readingBook=_readingBook;
...
- (void)reloadData;
@property(nonatomic) __weak KSYD_ScrollBar *scrollBar; // @synthesize scrollBar=_scrollBar;
