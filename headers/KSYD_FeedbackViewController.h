...
@class AFHTTPSessionManager, KSYD_NetworkManager, KSYD_TextField, KSYD_TextView, NSString, NSURLSessionTask, UIButton, UILabel, UIView, UIWindow;

@interface KSYD_FeedbackViewController : UIViewController <UITextViewDelegate>
{
...
- (void)KSYD_clearText;
- (void)KSYD_clickSend:(id)arg1;
- (void)KSYD_messageList;
