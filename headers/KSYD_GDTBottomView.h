...
@protocol KSYD_GDTBottomViewDelegate;

@interface KSYD_GDTBottomView : UIView <GDTNativeExpressAdDelegete, KSYD_GDTBottomViewDelegate>
{
    GDTNativeExpressAdView *_nativeExpressAdView;
    GDTNativeExpressAd *_nativeExpressAd;
    KSYD_AdvertConfigModel *_ADModel;
    id <KSYD_GDTBottomViewDelegate> _mydelegate;
...
@property(nonatomic) __weak id <KSYD_GDTBottomViewDelegate> mydelegate; // @synthesize mydelegate=_mydelegate;
