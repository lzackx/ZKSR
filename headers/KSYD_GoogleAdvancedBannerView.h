...
@class GADAdLoader, GADNativeAd, GADNativeAdView, KSYD_AdvertConfigModel, KSYD_ReaderSettings, NSString, UILabel;
@protocol KSYD_GoogleAdvancedBannerViewDelegate;

@interface KSYD_GoogleAdvancedBannerView : UIView <GADNativeAdLoaderDelegate, GADVideoControllerDelegate, GADNativeAdDelegate>
{
    GADNativeAd *_nativBannerAd;
    KSYD_AdvertConfigModel *_ADModel;
    id <KSYD_GoogleAdvancedBannerViewDelegate> _mydelegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <KSYD_GoogleAdvancedBannerViewDelegate> mydelegate; // @synthesize mydelegate=_mydelegate;
