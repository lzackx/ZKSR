...
@interface KSYD_NetworkManager : NSObject
{
...
- (id)getHttpHeader;
- (id)getWithAPIKSYD_Type:(long long)arg1 parameter:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (id)initLoginManager;
- (id)initManager;
