...
@class CommentSendViewContainer, KSYD_AdvertContentView, NSMutableArray, NSString, UITableView;

@interface KSYD_NewComTableViewController : KSYD_BaseViewController <UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, KSYD_AdvertContentViewDelegate>
{
    _Bool _canScroll;
    _Bool _isShowTop;
    NSString *_type;
    ...
    KSYD_AdvertContentView *_middleADContentView;
...
- (void).cxx_destruct;
- (void)KSYD_getCommentListData;
- (void)KSYD_initInfoADView;
- (void)KSYD_loadMoreLFData;
...
@property(retain, nonatomic) KSYD_AdvertContentView *middleADContentView; // @synthesize middleADContentView=_middleADContentView;
- (void)reloadData;
