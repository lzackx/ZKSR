...
@class CommentSendViewContainer, KSYD_CommentModel, KSYD_NetworkManager, NSDictionary, NSMutableArray, NSString, UITableView;

@interface KSYD_NewReplyCommenViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, CommentSendViewContainerDelegate>
{
...
- (void)KSYD_setupReplyTableViewUI;
...
@property(retain, nonatomic) KSYD_CommentModel *topModel; // @synthesize topModel=_topModel;
