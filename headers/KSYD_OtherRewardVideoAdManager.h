...
@interface KSYD_OtherRewardVideoAdManager : NSObject <GADFullScreenContentDelegate, BUNativeExpressRewardedVideoAdDelegate, GDTRewardedVideoAdDelegate, KSRewardedVideoAdDelegate>
{
...
@property(nonatomic) NSString *readerRewardIndex; // @synthesize readerRewardIndex=_readerRewardIndex;
@property(nonatomic) NSString *readerRewardKey; // @synthesize readerRewardKey=_readerRewardKey;
