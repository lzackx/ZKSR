...
@class UIColor;
@protocol KSYD_ScrollBarDelegate;

@interface KSYD_ScrollBar : UIView
{
    UIColor *_backColor;
    UIColor *_foreColor;
    ...
    double _barHeight;
    double _yPosition;
    id <KSYD_ScrollBarDelegate> _delegate;
    UIView *_scrollBar;
    UIView *_backView;
}
...
- (void)creatControl;
@property(nonatomic) __weak id <KSYD_ScrollBarDelegate> delegate; // @synthesize delegate=_delegate;
