...
@class KSYD_channelModel;

@interface KSYD_SelectChannelModel : NSObject
{
    _Bool _resident;
    _Bool _editable;
    _Bool _selected;
    KSYD_channelModel *_channelModel;
    unsigned long long _tagType;
}

- (void).cxx_destruct;
@property(retain, nonatomic) KSYD_channelModel *channelModel; // @synthesize channelModel=_channelModel;
