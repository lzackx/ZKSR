...
@interface KSYD_UserCenterViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
{
...
- (void).cxx_destruct;
- (void)KSYD_bindPhone;
- (id)KSYD_buildLabel:(id)arg1 orignY:(double)arg2;
- (id)KSYD_buildLabel:(id)arg1 textfiledWithorignY:(double)arg2;
- (void)KSYD_buildUI;
- (void)KSYD_clickHeadBtn;
- (void)KSYD_modifyPassword;
- (void)KSYD_upDateHeadIcon:(id)arg1;
- (void)KSYD_updateNickName;
- (void)KSYD_updateUserNickName;
