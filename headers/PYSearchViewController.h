...
@class KSYD_AdvertContentView, KSYD_NetworkManager, KSYD_SearchContentController, NSArray, NSMutableArray, NSString, PYSearchSuggestionViewController, UIBarButtonItem, UIButton, UIColor, UILabel, UISearchBar, UITableView, UIView;
@protocol PYSearchViewControllerDelegate;

@interface PYSearchViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, KSYD_AdvertContentViewDelegate>
{
    _Bool _isComic;
    ...
    UIView *_searchResultTableView;
    KSYD_SearchContentController *_searchResultController;
...
@property(retain, nonatomic) KSYD_SearchContentController *searchResultController; // @synthesize searchResultController=_searchResultController;
@property(nonatomic) long long searchResultShowMode; // @synthesize searchResultShowMode=_searchResultShowMode;
@property(nonatomic) __weak UIView *searchResultTableView; // @synthesize searchResultTableView=_searchResultTableView;
